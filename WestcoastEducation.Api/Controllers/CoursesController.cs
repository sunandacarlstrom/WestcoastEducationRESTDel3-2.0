...
public class CoursesController : ControllerBase
{
    ...
    public async Task<ActionResult> ListAll()
    {
        ...
        .Select(c => new
        {
            ...
            Id = c.Id,
            // gör en kontroll att det finns en lärare till varje kurs, annars skickas en textsträng ut likt ett felmeddelande 
            Teacher = c.Teacher != null ? c.Teacher.Name : "Lärare saknas",
